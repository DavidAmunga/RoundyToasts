...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public static final String TABLE_GENDER_TYPES = "genderTypes";
...
//    ID TYPE
    ...
    public void insertGenderTypes(String id, String name) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(DatabaseHandler.name, name);
        values.put(DatabaseHandler.id, id);
        db.insert(TABLE_GENDER_TYPES, null, values);
        db.close();
    }
