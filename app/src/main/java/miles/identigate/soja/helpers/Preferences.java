...
public class Preferences {
    ...
    public String getBaseURL() {
        String baseUrl = settings.getString("base_url", "http://sportpesa.soja.co.ke/soja-rest/index.php/api/visits/");
    ...
    public String getResidentsURL() {
        String residents_url = settings.getString("residents_url", "http://sportpesa.soja.co.ke/soja-rest/index.php/api/residents/");
